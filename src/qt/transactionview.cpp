 ...
 */
    ...
    typeWidget->addItem(tr("Received Tbr from zTbr"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zTbr"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zTbr));
