...
#   c) node1 mines 32 blocks, so now node 0 has 60001tbr, node 1 has 4250tbr, node2 has none.
#   d) node0 sends 601 tbr to node2, in two transactions (301 tbr, then 300 tbr).
